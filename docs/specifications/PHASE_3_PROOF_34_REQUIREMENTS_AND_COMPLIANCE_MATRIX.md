...
| R34-015 | Robots policies       | `acquisition.robots.crawl_delay.enforce` default `true` **if the selected registered parser supports Crawl-delay**.                                                                                                | Owner approved default `true` with `protego==0.6.2`; runtime registration and capability proof are absent.                                                                 | Register against the approved parser after capability is verified; observed Crawl-delay and effective enforcement remain separate.                                                                                                                                                       | **OWNER APPROVED / IMPLEMENTATION GAP**                 |
| R34-016 | Robots policies       | `acquisition.robots.cache.max_age_seconds`.                                                                                                                                                                        | Owner approved default `86400` and closed integer range `300..86400`; policy registration is absent.                                                                       | Register the approved default and bounds, reject booleans, and prove default/scoped resolution.                                                                                                                                                                                          | **OWNER APPROVED / IMPLEMENTATION GAP**                 |
| R34-017 | Robots policies       | `acquisition.robots.cache.max_stale_seconds`.                                                                                                                                                                      | Owner approved default `604800` and closed integer range `0..2592000`; policy registration is absent.                                                                       | Register the approved default and bounds, reject booleans, and prove default/scoped resolution.                                                                                                                                                                                          | **OWNER APPROVED / IMPLEMENTATION GAP**                 |
| R34-018 | Robots policies       | `acquisition.robots.fetch_limits` closed versioned object with response bytes, redirects, connect timeout and read timeout.                                                                                        | Owner approved all four defaults and closed ranges; policy registration is absent.                                                                                          | Register the exact approved v1 object. Missing, unknown, out-of-range, boolean, and other wrong-type fields must fail; scoped values cannot exceed installation egress hard limits.                                                                                                       | **OWNER APPROVED / IMPLEMENTATION GAP**                 |
...
| R34-047 | Health UI             | Compact robots summary relative to the publisher.                                                                                                                                                                  | Not present.                                                                                                                                                               | Show green `Allows`; red `Disallows` plus `Override`; or green `Disallows` plus accessible `Owner override active`. Preserve external finding separately from effective enforcement and support unavailable/stale/not-checked states.                                                                                                                  | **OWNER DESIGN APPROVED / IMPLEMENTATION GAP**          |
